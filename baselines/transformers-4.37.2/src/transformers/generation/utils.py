...
class GenerationMixin:
    ...
    def generate(
        ...
        **kwargs,
        ...
        if False:
        # if halc_decoding and dola_decoding and generation_mode == GenerationMode.GREEDY_SEARCH:
            if generation_config.num_return_sequences > 1:
                raise ValueError(
                    f"num_return_sequences has to be 1, but is {generation_config.num_return_sequences} when doing"
                    " greedy search."
                )
            print("\033[41m!!!!! Halc-Dola Greedy Decoding !!!!!!\033[0m")
                    ...
                    if detect_info["status"] == "invalid":
                        ...
                        if skip_flag == True:
                            ...
                            if eos_token_id is not None:
                                ...
                                nominate_tokens = nominate_tokens * unfinished_sequences + pad_token_id * (
        ...
        while True:
            ...
            if token_to_append != None:
                ...
                if last_word != current_word:
                    ...
                    next_token_logits = intermediate_outputs.logits[:, -1, :]

                    # pre-process distribution
                    next_tokens_scores = logits_processor(intermediate_token_lists, next_token_logits)
    ...
    def get_intermediate_logits(
        self,
        teacher_forcing_tokens: torch.LongTensor,
        input_ids: torch.LongTensor,
        logits_processor: Optional[LogitsProcessorList] = None,
        stopping_criteria: Optional[StoppingCriteriaList] = None,
        logits_warper: Optional[LogitsProcessorList] = None,
